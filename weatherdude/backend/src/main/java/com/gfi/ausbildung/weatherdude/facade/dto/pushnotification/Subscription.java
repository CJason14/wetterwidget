...
/**
 * Klasse, die die Subscription zwischen Client und Server transportiert.
 * 
 * Übertragen wird der Endpunkt, wann die Subscription abläuft und die Schlüssel 
 */
public class Subscription
{
   ...
   * @param expirationTime   Gültigkeitsdauer
   * @param keys             Schlüssel zum Austausch der Daten
   */
  @JsonCreator
  ...
  {
    return "Subscription [endpoint=" + this.endpoint + ", expirationTime=" + this.expirationTime + ", keys=" + this.keys
        + "]";
  }
